...
import { ClientInformationSection as ClientInfoData } from "@/types/JobDetailsTypes";
    ...
    <div className="bg-white">
      ...
      <div className="space-y-3 sm:space-y-4 border border-gray-200 p-3 sm:p-4 rounded-2xl">
        <div className="flex items-center justify-between py-1.5 sm:py-2 border-b border-gray-100">
          ...
          <p className="text-gray-500 text-xs sm:text-sm">{data.name}</p>
        </div>
        <div className="flex items-center justify-between py-1.5 sm:py-2 border-b border-gray-100">
          <p className="text-gray-800 font-medium text-sm sm:text-base">
            Contact Number :
        ...
        <div className="flex items-center justify-between py-1.5 sm:py-2 border-b border-gray-100">
          ...
          <p className="text-gray-500 text-xs sm:text-sm">{data.address}</p>
        </div>
        <div className="flex items-center justify-between py-1.5 sm:py-2 border-b border-gray-100">
          <p className="text-gray-800 font-medium text-sm sm:text-base">
            Locality :
          </p>
          <p className="text-gray-500 text-xs sm:text-sm">{data.town}</p>
        </div>
        <div className="flex items-center justify-between py-1.5 sm:py-2 border-b border-gray-100">
          <p className="text-gray-800 font-medium text-sm sm:text-base">
            Notes :
